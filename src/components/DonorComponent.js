...
class Donor extends Component {
  ...
  handleSubmit(event) {
    ...
    const datas = {
      altMobileNumber: this.state.mobilenumalt,
      availability: this.state.willdonate,
      bloodGroup: this.state.bloodgroup,
      city: this.state.city,
      donarType: this.state.recovered === "yes" ? "plasma" : "blood",
    ...
    axios.post('https://1ddd-117-193-28-201.in.ngrok.io/donor/signup', datas, config)
        .then(response => {
          if(response.data.status === "200"){
            this.setState({msg: "Your Data Added Go Back to Home Page"})
          }
        })
        ...
        >
          ...
          <ModalBody>
            ...
            >
              ...
              {/* <p>Your Data Added Successfully <br />Close and Go Back</p> */}
