...
import LoggedInHeader from "./LoggedInHead";
    ...
    <div>
      ...
      <div className="row row-content text-center col-md-10">
        ...
        >
          ...
          <br />
          Through this website, we seek blood and blood component donors who are
          willing to donate blood, plasma, platelets as well as provide the
          timeliest support to those in frantic need of it.
        </p>
      </div>
      <Row style={{ backgroundColor: "#ccccb3" }}>
        <Media className="col-12">
          ...
          <Media body className="mr-5 text-center col-md-8">
